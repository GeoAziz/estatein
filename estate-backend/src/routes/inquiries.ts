...
import { CreateInquirySchema, ReplySchema, UpdateInquiryStatusSchema, UpdateViewingStatusSchema, UpdateViewingScheduleSchema } from "../validators/common.js";
...
router.put("/:id/viewing-schedule", requireAuth, validate(UpdateViewingScheduleSchema), inquiriesController.updateViewingSchedule);
